    ...
    <>
      ...
      <Section className="grid lg:grid-cols-2 gap-12 items-center">
        ...
        <Reveal delay={0.08} className="relative aspect-[4/3] overflow-hidden">
          <Image
            src="/images/youth-garden.jpg"
            alt="Youth and a staff member planting flowers together"
            fill
        ...
        <Section className="max-w-3xl">
          <Reveal>
            ...
            <p className="mt-5 text-lg text-ink/80 leading-relaxed">
              Names and portraits are placeholders until the licensed team is confirmed. Staff
              exist so young people can have a house that holds.
            </p>
