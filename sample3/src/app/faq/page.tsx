        ...
        <div className="divide-y divide-gold/30">
          {faqs.map((f) => (
            <details key={f.q} className="group py-5">
              <summary className="cursor-pointer list-none flex items-start justify-between gap-4 font-display text-xl text-espresso">
                {f.q}
                <span className="text-gold-deep text-2xl leading-none transition-transform group-open:rotate-45">
                  +
                </span>
              </summary>
